...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>ahschoolerp</title>
        <meta
          name="description"
          content="ahschoolerp is a full erp system for school management"
        />
        <meta property="og:title" content="ahschoolerp" />
        <meta
        ...
        <div className="home-links-container">
          <div className="home-container3">
            <div className="home-container4">
              <span className="home-text06">Product</span>
              <span className="home-text07">Features</span>
              <span className="home-text08">Pricing</span>
              <span className="home-text09">Tutorials</span>
              <span>Releases</span>
            </div>
            <div className="home-container5">
              <span className="home-text11">Company</span>
              <span className="home-text12">About</span>
              <span className="home-text13">Careers</span>
          ...
          <div className="home-container6">
            <div className="home-container7">
              ...
              <span className="home-text17">Terms of service</span>
              <span className="home-text18">Privacy Policy</span>
              <span className="home-text19">Legal</span>
              <span>Help center</span>
            </div>
            <div className="home-container8">
              <span className="home-text21">Resources</span>
              <span className="home-text22">Blog</span>
              <span className="home-text23">Pricing</span>
              <span className="home-text24">Service</span>
              <span>Product</span>
            </div>
          </div>
        </div>
